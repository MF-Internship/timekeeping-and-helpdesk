...
maintainability_paths=(backend/core backend/config backend/operations scripts frontend/src/shared/api/client.ts)
...
uv run --project backend mypy backend/core backend/config backend/operations scripts
