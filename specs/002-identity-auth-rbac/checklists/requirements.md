...
- The requested Definition of Done is covered by FR-041 and SC-012 and traced across User Stories 1–5: login, refresh rotation/reuse, idempotent actor-derived logout revocation, per-request inactive and correctly ordered forced-password-change gates, password reset, Manager-target protection, Leader mutation denial, the full RBAC matrix, generic implication provenance, and explicit ownership deferral to Features 004 and 006.
- Governance synchronization R-110…R-112 closes logout-cookie semantics, repeated state/revocation evidence, and exact shared-cache authentication throttles; all 16 checklist items remain passing.
