...
| GitHub status inspection | GitHub CLI is unavailable in the current environment | Inspect checks after push through available authenticated GitHub access | NOT VERIFIED |
